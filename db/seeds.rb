# 請求元
requestors = %w(株式会社A 株式会社B 山田太郎 C株式会社 日本花子)
5.times do |n|
...
# 一般ユーザー
4.times do |n|
  User.create!(email: "test0#{(n + 2).to_s}@example.com", password: "password", password_confirmation: "password", role: 0)
end
...
# memos = ["", "振込時期変更の可能性あり", "金額が間違っていないか先方に確認中", "請求取り消しの可能性あり"]
# requestor_ids = (1..5).to_a
# user_ids = (1..5).to_a
...
# # 請求書画像
# details_subjects = ["原稿執筆料", "入稿料", "SNS(Twitter)運用費", "事務用品代", "クラウド利用費"]
# images = ["sample_invoice.png", "sample_invoice2.png", "sample_invoice3.png", "sample_invoice4.png"]
# invoice_ids = (1..5).to_a
